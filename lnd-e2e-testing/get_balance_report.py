...
date = subprocess.check_output(["date", "-Iseconds"]).decode("utf-8").strip()  # shows local Timezone
...
## 0   *  *   *   *     (source ~/.profile; ~/lnd-e2e-testing/get_balance_report.py --no-header >> ~/balance_history.tab) 2> /tmp/stder_cron_get_balance_report
...
# 2018-07-12T20:18:00-0700  154,430,415  0            0          124,546,659  71,093     278,977,074
# 2018-07-13T07:36:00-0700  153,211,432  0            0          123,710,571  74,055     276,922,003
# 2018-07-13T07:58:00-0700  144,057,139  9,152,804    3,221,709  119,914,308  75,177     273,124,251
